...
import { FaBoxOpen, FaShoppingCart, FaUserPlus, FaHome, FaSignOutAlt } from "react-icons/fa";
  ...
  return (
    <aside style={styles.sidebar}>
      ...
      <ul style={styles.menu}>
        ...
        {/* Inventario */}
        <li style={styles.menuItem}>
          <div style={styles.menuLabel} onClick={() => setOpenInventario((v) => !v)}>
            <div style={styles.menuTitle}>
          ...
          {!isCollapsed && (
            <ul style={openInventario ? styles.submenuShow : styles.submenu}>
              <li style={styles.submenuItem} onClick={() => navigate("/Insumos")}>Insumos</li>
              <li style={styles.submenuItem} onClick={handlePrendas}>Prendas</li>
            </ul>
          )}
        </li>
        ...
        {/* Pedidos */}
        <li style={styles.menuItem}>
          <div style={styles.menuLabel} onClick={() => setOpenPedidos((v) => !v)}>
            <div style={styles.menuTitle}>
          ...
          {!isCollapsed && (
            <ul style={openPedidos ? styles.submenuShow : styles.submenu}>
              <li style={styles.submenuItem} onClick={handleRealizarPedido}>Realizar pedido</li>
              <li style={styles.submenuItem} onClick={handleDetallePedidos}>Detalle de Pedidos</li>
              <li style={styles.submenuItem} onClick={handleAprobacionPedidos}>Aprobación de pedidos</li>
            </ul>
          )}
        </li>
        ...
        {/* Usuarios */}
        <li style={styles.menuItem}>
          <div style={styles.menuLabel} onClick={handleUsuarios}>
            <div style={styles.menuTitle}>
